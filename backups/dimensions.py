...
class fishTank(ShowBase):
    ...
    def createTank(self):
        ...
        self.tankWidth, self.tankHeight, self.tankLength = 4, 2, 6
        self.tankScale = 15
    ...
    def getTankDims(self):
        return self.tankScale, self.tankWidth, self.tankHeight, self.tankLength
...
class EverythingFish(fishTank):
    ...
    def __init__(self, fishModel, position, tankDims):
        ...
        self.tankScale, self.tankWidth, self.tankHeight, self.tankLength = tankDims
    ...
    def checkBounds(self):
        ...
        if self.zPosition < margin: # actual basically bottom is 4
            self.upDownFish(0) # make fish move up
            return True
        if self.zPosition > zLimit - margin: # actual basically top is 30
            self.upDownFish(1)
            return True
        ...
        # if self.yPosition > 30:
        #     self.leftRightFish(0)
        # if self.yPosition < 10:
        #     self.leftRightFish(1)
