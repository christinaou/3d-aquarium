...
class fishTank(ShowBase):
    ...
    def setUpButtons(self):
        ...
        self.switchCamFront = DirectButton(text = ("Aerial View"), scale=0.05,
            command = self.switchAer, pos = (-.17, 0, +1), 
            parent = base.a2dBottomRight)
    ...
    def evenMoreButtons(self):
        ...
        self.addButt2 = DirectButton(text = ("Add more fish"), scale = 0.06,
            command = self.addFish, pos = (.6, 0,+.35), parent = base.a2dBottomCenter)
    ...
    def aqSplash(self):
        ...
        self.camDownButt.show() # button for moving camera down
...
##### ADDING FISH
    ...
    def addfishGUI(self):
        ...
        self.makeFishButt.destroy() # button to start adding a fish
    ...
    def moveFish(self):
        # hides all the bottom left images and 
