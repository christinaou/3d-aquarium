...
### BUTTONS
    ...
    def evenMoreButtons(self):
        self.userFishButt = DirectButton(text = ("Add own fish"), scale = 0.06,
            command = self.swimAsFish, pos = (.6, 0,+.05), 
            parent = base.a2dBottomCenter)
        self.fishViewButt = DirectButton(text = ("Fish View"), scale = 0.075,
            command = self.fishView, pos = (+.6,0,+.1), 
            parent = base.a2dBottomCenter)
        self.feedButt = DirectButton(text = ("Feed fish"), scale = 0.08,
            command = self.feedFish, pos = (+.6, 0, +.2), 
            parent = base.a2dBottomCenter)
...
### USER FISH MODE
    ...
    def swimAsFish(self):
        self.userFish = True # type is now userFish
...
# keys control turning left/right and up/down
    def checkMove(self):
        self.accept("arrow_up", self.upDownFish, [0])
        self.accept("arrow_down", self.upDownFish, [1])
