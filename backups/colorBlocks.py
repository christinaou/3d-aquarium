...
class DirectGUIObjects(object):
    ...
    def colorImages(self):
        self.viewBack = OnscreenImage(image = 'pics/medPurp.png',
            pos = (-.06,0,.2), parent = base.a2dBottomCenter, 
            scale=(.45,0,.21))
        self.runBack = OnscreenImage(image = 'pics/lightBlue.png', 
            pos = (-.23, 0, +.2), scale = (0.22,0,0.21), 
            parent = base.a2dBottomRight)
        self.firstAddBack = OnscreenImage(image = 'pics/grayBlue.png',
            pos = (.8, 0, +.2), scale = (0.45,0,0.21), 
            parent = base.a2dBottomCenter)
        self.chooseBack = OnscreenImage(image = 'pics/darkPurp.png', 
            pos = (.5, 0, .2), scale = (0.93,0,0.21), 
            parent = base.a2dBottomLeft)
        self.menuBack = OnscreenImage(image = 'pics/grayBlue.png',
            pos = (.5,0,+.2), parent = base.a2dBottomCenter, scale=(.6,0,.21))
        self.foodBack = OnscreenImage(image = 'pics/medPurp.png',
            pos = (0,0,+.2), parent = base.a2dBottomCenter, scale=(.35,0,.21))
    ...
    def DirectGUIImages(self):
        ...
        self.foodpic = OnscreenImage(image = "pics/fishfood.png", 
            pos = (+0,0,+.23), scale = 0.1, parent = base.a2dBottomCenter)
...
### DirectGUI Text
    ...
    def DirectGUIText(self):
        ...
        self.pickFish = OnscreenText(text = 
            ...
            scale = 0.05, pos = (+.45,+.2), fg = (1,1,1,1),
    ...
    def moreText(self):
        ...
        self.runText = OnscreenText(text = "Hit run to start\nthe simulation!",
            fg = (0,0,0,1),scale = 0.04, pos = (-.25, +.325), 
            parent = base.a2dBottomRight)
        ...
        self.GUIObjs += ([self.nameFish] + [self.pickType] + [self.addingFish] 
            + [self.runText] + [self.escape] + [self.pauseText])
        self.evenMoreText()
    ...
    def evenMoreText(self):
        ...
        self.topText = OnscreenText(text = 
            "Select fish from below\nto view from", 
            fg = (1,1,1,1), scale = 0.05, pos = (-.5, -.1), 
            parent = base.a2dTopCenter)
        self.GUIObjs += ([self.camText] + [self.topText])
...
### BUTTONS
    ...
    def setUpButtons(self):
        self.aqSim = DirectButton(text = ("Aquarium Simulation"), scale = 0.06,
            command = self.aqSplash, pos=(0,0,-1.45), parent=base.a2dTopCenter)
        self.makeFishButt = DirectButton(text = ("Add Fish"), 
            parent = base.a2dBottomCenter, pos = (.6, 0,+.3), 
    ...
    def evenMoreButtons(self):
        self.userFishButt = DirectButton(text = ("Add user fish"), scale = 0.06,
            command = self.swimAsFish, pos = (.6, 0,+.04), 
            parent = base.a2dBottomCenter)
        self.fishViewButt = DirectButton(text = ("Fish View"), scale = 0.07,
            command = self.fishView, pos = (+.6,0,+.12), 
            parent = base.a2dBottomCenter)
        self.feedButt = DirectButton(text = ("Feed fish"), scale = 0.07,
            command = self.feedFish, pos = (+.6, 0, +.21), 
            parent = base.a2dBottomCenter)
        self.addButt2 = DirectButton(text = ("Add more fish"), scale = 0.06,
            command = self.addFish2, pos = (.6, 0,+.3), 
            parent = base.a2dBottomCenter)
    ...
    def extraEvenMoreButtons(self):
        self.grabFoodButt = DirectButton(text = ("Grab Food"), scale = 0.06,
            command = self.grabFood, pos = (0, 0,+.075), 
            parent = base.a2dBottomCenter)
        self.exitViewButt = DirectButton(text = ("Exit fish view"), 
            scale = 0.08, command = self.clearFishView, pos = (0, 0,+.2), 
            parent = base.a2dBottomCenter)
...
### ADDING FISH
    ...
    def addFishPrep(self):
        ...
        self.hideFishImages()
        if not self.makingUserFish:
            self.dirGUI.firstAddBack.show() # background
    ...
    def addFish(self, typeFish):
        ...
        if typeFish == "Community":
            ...
            self.parentCam(len(self.fishList)-1) # parent camera to this fish
