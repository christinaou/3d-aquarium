...
class fishTank(ShowBase):
    ...
    def GUI(self):
        ...
        self.bTButt = DirectButton(text = ("Blue Tang", "Added","Add?", "disabled"),
            scale = 0.08, command = self.setFish, extraArgs = ["blue tang"], 
            pos = (-1,0,-.8))
        self.sFButt = DirectButton(text =("Sailfin Tang","Added","Add?","disabled"),
            scale = 0.08, command = self.setFish, extraArgs = ["sailfin tang"],
             pos = (-.5,0,-.8))
        self.yTButt = DirectButton(text =("Yellow Tang","Added","Add?","disabled"),
            scale = 0.08, command = self.setFish, extraArgs = ["yellow tang"],
            pos = (0,0,-.8))
        self.cFButt = DirectButton(text =("Clown Fish", "Added","Add?","disabled"),
