...
class fishTank(ShowBase):
    ...
    def __init__(self):
        ...
        # positioning is x, -y, z, where x is i, -y is k, z is j
        # self.marker2 = self.loader.loadModel("models/marker_01")
        # self.marker2.reparentTo(self.render)
        # self.marker2.setPos(0, -30, 0)
        ...
        # # positioning is x, -y, z, where x is i, -y is k, z is j
        # self.marker4 = self.loader.loadModel("models/marker_01")
        # self.marker4.reparentTo(self.render)
        # self.marker4.setPos(-45, 0, 30)
        ...
        # pos2 = (22, 35, 30)
        pos2 = (0, 0, 15)
        self.fishTwo = AggressiveFish(fish2, pos2, tankDims, [self.fishOne])
...
class AggressiveFish(EverythingFish):
    ...
    def findPitchChange(self):
        if self.xyChange == [0, -1]: return 0
        elif self.xyChange == [+1, -1]: return 45
        elif self.xyChange == [+1, 0]: return 90
        elif self.xyChange == [+1, +1]: return 135
        elif self.xyChange == [0, +1]: return 180
        elif self.xyChange == [-1, +1]: return 225
        elif self.xyChange == [-1, 0]: return 270
        elif self.xyChange == [-1, -1]: return 315
    ...
    def chaseFish(self, chasableFish):
        ...
        self.pitchChange = self.findPitchChange()
