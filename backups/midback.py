...
class DirectGUIObjects(object):
    ...
    def colorImages(self):
        ...
        self.runBack = OnscreenImage(image = 'pics/lightBlue.png', 
            ...
            parent = base.a2dBottomRight)
        self.firstAddBack = OnscreenImage(image = 'pics/grayTeal.png',
            pos = (.8, 0, +.2), scale = (0.45,0,0.21), 
            parent = base.a2dBottomCenter)
        self.chooseBack = OnscreenImage(image = 'pics/medPurp.png', 
            pos = (.5, 0, .2), scale = (0.93,0,0.21), 
            parent = base.a2dBottomLeft)
        self.menuBack = OnscreenImage(image = 'pics/grayPurp.png',
            pos = (.2,0,+.2), parent = base.a2dBottomCenter, scale = (.8,0,.21))
        self.GUIObjs += ([self.camBack] + [self.runBack] + [self.firstAddBack]
            + [self.chooseBack] + [self.menuBack])
...
### DirectGUI Text
    ...
    def DirectGUIText(self):
        ...
        self.pickFish = OnscreenText(text = 
            ...
            scale = 0.05, pos = (+.45,+.2), fg = (0,0,0,1),
    ...
    def moreText(self):
        ...
        self.GUIObjs += ([self.nameFish] + [self.pickType] + [self.addingFish] 
            + [self.runText] + [self.escape])
        self.evenMoreText()

    def evenMoreText(self):
        self.camText = OnscreenText(text = "Toggle Camera\nScreen View", 
            fg = (1,1,1,1), scale = 0.04,
            pos = (-.17, +1.25), parent = base.a2dBottomRight)

        self.GUIObjs += ([self.camText])
...
### BUTTONS
    ...
    def extraEvenMoreButtons(self):
        ...
        self.moreDirGUI += [self.grabFoodButt]
