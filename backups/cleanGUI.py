...
class fishTank(ShowBase):
    ...
    def splashScreen(self):
        ...
        self.aqSim = DirectButton(text = ("Aquarium Simulation"), scale = 0.06,
            command = self.addfishGUI, pos = (0,0,-1), parent = base.a2dTopCenter)
        try:
    ...
    def addfishGUI(self):
        ...
        self.createTank()
        self.topFishList = []
        # self.aqSimNode = render.attachNewNode("render-aqSimNode")
        # self.aqSimNode.setPos(1,0,0)
        ...
        self.feedButt = DirectButton(text = ("Feed fish"), scale = 0.08,
            command = self.feedFish, pos = (-.9, 0, 0))


    def feedFish(self):
        print("FEEEDDDDing")
        self.foodpic = OnscreenImage(image = "pics/fishfood.png", 
            pos = (-.9,0,-.14), scale = 0.1)
        base.camera.setPosHpr(0,0,150,0,-90,0)
