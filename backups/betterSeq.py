...
class fishTank(ShowBase):
    ...
    def __init__(self):
        ...
        fish3 = ["models/nemo_right_2", "models/nemo_left_2", "models/nemo_front_2", "tex/TropicalFish12.jpg"]
        pos3 = (20, -20, -5)
        type3 = "leftCircle"
        # self.fishThree = Fish(fish3, pos3, type3)

        fish4 = ["models/yellow_right_0", "models/yellow_left_0", "models/yellow_front_0", "tex/TropicalFish05.jpg"]
        pos4 = (10, 10, -10)
        type4 = "rightCircle"
        self.fishFour = Fish(fish4, pos4, type4)
...
class Fish(object):
    ...
    def __init__(self, fishModel, position, type):
