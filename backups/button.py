...
class fishTank(ShowBase):
    ...
    def __init__(self):
        ...
        base.trackball.node().setPos(0, 150, -5) # starting position of camera
        ...
        def setFish():
            print("hi")
            self.fishList += [Fish("blue tang", self.tankDims)]


        bT = DirectButton(text = ("blue tang", "click!", "rolling over", "disabled"),
            scale = 0.1, command = setFish(), pos = (-1,0,-.8))
        # addFish = DirectButton(text = ("Add Fish", "click!", "rolling over", "disabled"),
        #     scale = 0.1, command = setFish("blue tang"), pos = (-1,0,-.8))
...
class EverythingFish(fishTank):
    ...
    def createFish(self, fishType):
        ...
        # pos1 = (-22, 35, 30)
        # pos1 = (0, 0, 15)
        # self.fishOne = Fish(fish1, pos1, self.tankDims) # instantiated in fish class
        ...
        # pos2 = (22, 35, 30)
        pos2 = (10, 0, 15)
        # self.fishTwo = Fish(fish2, pos2, self.tankDims)
