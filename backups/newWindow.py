...
from panda3d.core import TextNode, NodePath, LightAttrib, WindowProperties
...
loadPrcFileData("", "win-size 500 400")
...
class fishTank(ShowBase):
    ...
    def __init__(self):
        ...
        wp = WindowProperties()
        wp.setSize(500, 500)
        wp.setOrigin(1000, 128)
        base.win.requestProperties(wp)
        self.render2 = NodePath("render2")
        win2 = base.openWindow(type = 'onscreen', scene = self.render2)
        ...
        base.trackball.node().setPos(0, 150, -15) # starting position of camera
        base.trackball.node().setHpr(0,20,0)
        # self.camera.setPos(0,150,-15)
