...
class fishTank(ShowBase):
    ...
    def setFish(self, fishType):
        ...
        self.menu = DirectOptionMenu(text="Add", scale=0.08,items=["Community","Aggressive"],
            highlightColor=(0.65,0.65,0.65,1), pos = (x-.1,0,-.9), command=self.addFish)
...
class AggressiveFish(EverythingFish):
    def __init__(self, fishType, tankDims, fishList):
        EverythingFish.__init__(self, fishType, tankDims)
    ...
    def __eq__(self, other):
        return (isinstance(other, EverythingFish) and (self.xPosition == 
            ...
            (self.zPosition == other.zPosition))
