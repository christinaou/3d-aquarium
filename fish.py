...
### FISH VIEW MODE
    ...
    def showAddMenu(self):
        ...
        # don't have user fish yet
        if not self.haveUserFish: self.userFishButt.show() 
...
### BOUNDS CHECKING
    ...
    def checkBounds(self):
        ...
        xLimit, xymargin = self.tankScale*self.tankLength, 14
    ...
    def checkYLimit(self):
        yLimit, xymargin = self.tankScale*self.tankWidth, 14
        zmargin = 10
        # hitting front wall
